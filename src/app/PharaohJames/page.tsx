...
const DESCRIPTION =
  "Autism Texas print hoodie from Pharaoh James — Founder Glenn family catalog.";
  ...
  return (
    <main className="min-h-screen bg-[#121212] px-6 py-20 text-zinc-100">
      <article className="mx-auto max-w-5xl border border-white/10 bg-white/[0.02] p-8 md:p-12">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-white md:text-5xl">Autism Texas Print Hoodie</h1>
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-zinc-400">
          Fleece hoodie with the Autism Texas print — worn and represented by Pharaoh James. When the storefront
          connection is live, pricing and checkout will appear here automatically.
        </p>
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-[minmax(0,400px),1fr] md:items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-zinc-400">
              ...
              <span className="text-zinc-300">Inquire to purchase</span> for now and we&apos;ll route you to the
              right link or size.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                Pharaoh James Glenn — full story
              </Link>
              <Link
                href="/founder-glenn"
