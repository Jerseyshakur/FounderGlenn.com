...
export default function NexusFeaturesPage() {
  ...
  return (
    <NexusPageShell title="Features" description="Core systems inside Nexus BodyOS.">
          ...
          {features.map((feature) => (
            <article key={feature} className="rounded-2xl border border-white/10 bg-black/25 p-5">
              ...
              <p className="mt-3 text-sm text-zinc-300">
                Nexus BodyOS translates this signal into practical guidance so users can align output with real
