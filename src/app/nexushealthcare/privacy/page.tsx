...
export default function NexusPrivacyPage() {
  return (
    <NexusPageShell
      ...
      description="How Nexus HealthKit handles Apple Health data, account information, and user privacy rights."
    >
      <div className="space-y-6">
        <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-7 md:p-9">
          ...
          <p className="mt-4 text-zinc-300">
            Nexus HealthKit integrates with Apple HealthKit to read user-authorized data. We never access Apple Health
        ...
        <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-7 md:p-9">
          ...
          <p className="mt-4 text-zinc-300">
            ...
            and training guidance. Nexus HealthKit does not sell health data.
          </p>
          <p className="mt-4 text-zinc-300">
