...
export const metadata = buildNexusMetadata({
  title: "Nexus BodyOS Terms of Service | Founder Glenn",
  description: "Terms of Service for Nexus BodyOS including use rules, subscriptions, and liability limitations.",
  path: "/NexusBodyOS/terms",
});
...
export default function NexusTermsPage() {
  return (
    <NexusPageShell
      ...
      description="Clear terms governing use of Nexus BodyOS, subscriptions, and service limitations."
    >
      <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-7 text-zinc-300 md:p-9">
        ...
        <p className="mt-4">
          By accessing Nexus BodyOS, you agree to use the app lawfully, follow platform policies, and avoid misuse
          of app services, accounts, or content.
        </p>

        <h3 className="mt-7 text-xl font-semibold text-white">Acceptable Use</h3>
        <p className="mt-3">
          You may not attempt to reverse engineer, disrupt service integrity, or use Nexus BodyOS for fraudulent or
          abusive behavior.
        </p>
        ...
        <p className="mt-3">
          Refund eligibility is determined by Apple’s billing policies. Nexus BodyOS does not independently process
          App Store subscription refunds.
        </p>

        <h3 className="mt-7 text-xl font-semibold text-white">Liability Limitation</h3>
        <p className="mt-3">
          Nexus BodyOS provides informational analytics and is not medical advice. Use of analytics and performance
